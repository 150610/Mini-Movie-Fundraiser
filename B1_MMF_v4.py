...
def string_check(question, valid_ans_list=('yes','no'), num_letters=1):
    ...
    while True:
        ...
        print(f"Please choose an answer from this list: {valid_ans_list}")
...
entered the exit code ('xxx'), the program will display the 
ticket sales information and write the data to a text file. 

It will also choose one lucky ticket holder whp wins the draw (their ticket is free).
...
# ask the user if they want instructions and
...
adjusted_explanation = (f"We have given away a ticket worth ${ticket_won:.2f} which\n"
                        f"means our sales have decreased by ${ticket_won:.2f} and\n"
                        f"our profit decreased by ${profit_won:.2f}")
